...
const translations = {
  en: {
    ...
    pickupPriorityBadge: "Pickup flow",
    pickupPriorityTitle: "Simple pickup and delivery",
    pickupPriorityText:
      "Choose your branch, select pickup or delivery, and confirm your order with a quick checkout flow.",
    pickupPriorityDepositTitle: "MoMo deposit",
    pickupPriorityDepositText: "Customers see the 500 RWF confirmation deposit clearly before placing a pickup order.",
    ...
    pickupPriorityOpsTitle: "Clear order updates",
    pickupPriorityOpsText: "Customers can follow a simpler order journey from basket to confirmation and pickup readiness.",
    ...
    workflowText: "The homepage explains the shopping flow clearly before users ever hit checkout.",
    ...
    workflowStepThreeTitle: "Receive clear confirmation",
    workflowStepThreeText: "Get a simple confirmation flow so you know when your order is ready for pickup or delivery.",
  ...
  fr: {
    ...
    pickupPriorityBadge: "Parcours retrait",
    pickupPriorityTitle: "Retrait et livraison simplifies",
    pickupPriorityText:
      "Choisissez votre branche, selectionnez le retrait ou la livraison, puis confirmez votre commande avec un parcours de paiement rapide.",
    pickupPriorityDepositTitle: "Depot MoMo",
    pickupPriorityDepositText: "Les clients voient clairement le depot de confirmation de 500 RWF avant de valider une commande en retrait.",
    ...
    pickupPriorityOpsTitle: "Mises a jour claires",
    pickupPriorityOpsText: "Les clients suivent un parcours de commande plus simple, du panier a la confirmation et a la disponibilite du retrait.",
    ...
    workflowText: "La page d'accueil explique clairement le parcours d'achat avant le paiement.",
    ...
    workflowStepThreeTitle: "Recevez une confirmation claire",
    workflowStepThreeText: "Suivez facilement quand votre commande est prete pour le retrait ou la livraison.",
    branchesShowcaseBadge: "Branches",
  ...
  rw: {
    ...
    pickupPriorityBadge: "Uko gutwara bigenda",
    pickupPriorityTitle: "Pickup na delivery byoroshe",
    pickupPriorityText:
      "Hitamo ishami ushaka, uhitemo pickup cyangwa delivery, hanyuma wemeze order yawe ukoresheje uburyo bworoshye bwo kwishyura.",
    pickupPriorityDepositTitle: "MoMo deposit",
    pickupPriorityDepositText: "Abakiriya babanza kubona neza deposit ya 500 RWF mbere yo kohereza order ya pickup.",
    ...
    pickupPriorityOpsTitle: "Amakuru agaragara neza",
    pickupPriorityOpsText: "Umukiriya akurikirana neza urugendo rwa order kuva mu gaseke kugera ku iyemezwa no kuba yiteguye.",
    ...
    workflowText: "Home page isobanura neza uko kugura bigenda mbere y'uko umuntu ajya kuri checkout.",
    ...
    workflowStepThreeTitle: "Haboneke iyemezwa risobanutse",
    workflowStepThreeText: "Menya byoroshye igihe order yawe yiteguye gufatwa cyangwa koherezwa.",
